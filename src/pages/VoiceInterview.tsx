                    ...
                    {!hasStarted ? (
                        ...
                        >
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl text-foreground font-medium max-w-3xl mx-auto mb-8">
                                ...
                                <div className="grid md:grid-cols-3 gap-8 relative max-w-4xl mx-auto">
                                    {[
                                        ...
                                        <div key={index} className="flex flex-col items-center text-center relative z-10">
                                            ...
                                            <p className="text-sm text-foreground font-medium">{step.desc}</p>
                                            {/* Desktop Line */}
                                            {index < 2 && (
                                ...
                                <div className="lg:col-span-2 space-y-8">
                                    ...
                                    <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 border border-blue-500/20 flex flex-col sm:flex-row items-center justify-between gap-6">
                                        <div>
                                            ...
                                            <p className="text-foreground font-medium">Start the interactive voice interview now. No account needed.</p>
                                        </div>
                        ...
                        >
                            <Card className="w-full p-8 shadow-lg">
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-foreground font-medium">Software Engineer Role • AI Interviewer: Aria</p>
                                </div>
