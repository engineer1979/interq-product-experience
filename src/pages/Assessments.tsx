...
import { IT_CATEGORIES } from "@/data/itCategories";
  ...
  const fetchAssessments = async () => {
    try {
      ...
      const dummyData: Assessment[] = [
        { id: "it-1", title: "IT Fundamentals", description: "Core IT concepts and basics", category: "IT", difficulty: "medium", duration_minutes: 30, is_published: true },
        { id: "it-2", title: "Network Essentials", description: "Networking and protocols overview", category: "IT", difficulty: "easy", duration_minutes: 20, is_published: true },
        { id: "it-3", title: "System Administration", description: "Operating systems and administration", category: "IT", difficulty: "hard", duration_minutes: 45, is_published: true },
      ];
