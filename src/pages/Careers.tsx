...
const MOCK_JOBS: Job[] = [
    ...
    },
    {
        ...
        employment_type: "Full-time",
        description: "Drive the product vision and strategy for our core assessment platform.",
        ...
        const fetchJobs = async () => {
            try {
                ...
                if (error || !data || data.length === 0) {
                    console.warn("Using mock data for Careers page:", error);
                    setJobs(MOCK_JOBS);
                } else {
                    // Transform data if needed or just use as is
            ...
            <main className="flex-grow">
                ...
                <section className="pt-32 pb-20 px-4 bg-secondary/20">
                    <div className="container mx-auto text-center max-w-3xl">
                        ...
                        >
                            Join a passionate team building the next generation of fair, AI-powered interview tools.
                        </motion.p>
                        ...
                        >
                            ...
                            <Input
                                placeholder="Search roles (e.g. 'Engineer', 'Product')..."
                                className="pl-10 h-12 text-lg shadow-lg border-primary/20"
                                value={searchTerm}
                                    ...
                                    filteredJobs.map((job, index) => (
                                        ...
                                        >
                                            <Card className="h-full flex flex-col hover:shadow-lg transition-shadow border-primary/10">
                                                ...
                                                <CardFooter>
                                                    <Button className="w-full gap-2 group" onClick={() => navigate(`/apply/${job.id}`)}>
                                                        Apply Now
