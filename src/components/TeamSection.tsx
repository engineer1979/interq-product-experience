                    ...
                    {team.map((member, index) => (
                        ...
                        >
                            <Card className="h-full border-border/50 bg-card/50 hover:bg-card transition-all duration-300 hover:shadow-xl flex flex-col items-center text-center p-8">
                                {/* Image Container */}
                                <div className="relative w-[160px] h-[160px] mb-8 shrink-0">
                                    <div className="w-full h-full rounded-full overflow-hidden border-4 border-[#EAF0F6] shadow-[0_10px_25px_rgba(0,0,0,0.10)] relative group">
                                        <img
                                            src={member.image}
                                            alt={member.name}
