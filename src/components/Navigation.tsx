        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-3 group transition-smooth" onClick={() => setIsMobileMenuOpen(false)}>
              ...
              <span className="text-2xl font-bold text-primary group-hover:opacity-80 transition-smooth">
                InterQ
              </span>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              {user ? (
                ...
                <>
                  ...
                  <Link to="/auth">
                    <Button variant="default" className="btn-premium bg-slate-900 hover:bg-slate-800 text-sm shadow-soft transition-all duration-300">
                      Start Free Trial
                    </Button>
                  </Link>
                </>
                ...
                <div className="container mx-auto px-4 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
                  ...
                  {isAdmin && (
                    <Link
                      to="/settings"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className={`block text-lg font-medium p-3 rounded-lg transition-colors ${location.pathname === "/settings"
                        ? "bg-primary/10 text-primary"
                        : "text-foreground/80 hover:bg-muted hover:text-primary"
                        }`}
                    >
