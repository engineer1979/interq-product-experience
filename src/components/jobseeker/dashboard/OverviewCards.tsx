...
const cards = [
  ...
  { key: "certificates", label: "Certificates Earned", icon: Award, color: "text-indigo-600", bg: "bg-indigo-500/10" },
  { key: "saved", label: "Saved Jobs", icon: Bookmark, color: "text-violet-600", bg: "bg-violet-500/10" },
];

export function OverviewCards({ profileCompletion, jobsApplied, assessmentsCompleted, savedJobs, certificatesEarned, isLoading }: OverviewCardsProps) {
