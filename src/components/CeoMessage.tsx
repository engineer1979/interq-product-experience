        ...
        <section className="py-16 px-4 flex justify-center">
            ...
            >
                ...
                <div className="relative z-10 p-10 flex flex-col items-center text-center">
                    ...
                    <h3
                        className="ceo-message-header !text-white text-xs font-bold tracking-[0.3em] uppercase mb-8"
                        style={{
                    ...
                    {/* Body Content (Force White for maximum contrast) */}
                    <p className="ceo-message-body !text-white text-base md:text-lg leading-relaxed italic font-bold">
                    ...
                    <div className="mt-10 pt-8 border-t border-sky-400/20 w-full flex flex-col items-center">
                        <div
                            className="ceo-message-name !text-white font-bold text-xl tracking-tight mb-1"
                            style={{ textShadow: '0 0 10px rgba(255,255,255,0.2)' }}
                        >
                            Saima Huma
                        </div>
                        <div className="ceo-message-title !text-sky-300 font-bold tracking-[0.1em] text-[10px] uppercase">
